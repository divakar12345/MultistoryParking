...
import com.multistoryparking.app.databinding.FragmentCarAuditBinding
...
class CarAuditFragment : Fragment() {

    private lateinit var binding: FragmentCarAuditBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_car_audit, container, false)
    ...
    override fun onResume() {
        ...
        viewModel.paymentDetailsLiveData.observe(this, {
            val carArrayList = ArrayList<PaymentDetailsModel>()
            var totalAmount = 0.0
            for (data in it)
            ...
            if (carArrayList.isEmpty()) {
                ...
                adapter.submitList(carArrayList)
            }
        })
    }
}